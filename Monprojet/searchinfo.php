        ...
        <td><img class="prod" src="img_m/<?php echo $data['img_m'];?>"></td>
               ...
               <td><label><?php echo $data['adresse'];?></label></td>
                 <td><label><?php echo $data['prix'];?></label></td>
					...
					<td>
					<label><a onclick="return confirm('Etes vous sur de vouloir supprimer cette ligne?')" href="totalm.php?delete=<?php echo $data['id_personne']; ?>"><img src="minus.png"></a>
