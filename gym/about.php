        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4 bg-secondary">
                    ...
                    <a href="image.php" class="nav-item nav-link">store</a>
...
<div>
     <h4 class="text-primary font-weight-bold"style="text-align:center;">ZONES</h4>
            <h4 class="text-primary font-weight-bold" style="text-align:center;">JIMMY'S FITNESS CENTER EN IMAGES</h4>

              
 <img src="images_gym/image_gym_1.png" class="img-thumbnail" alt="Cinque Terre">
 <img src="images_gym/image_gym_2.jpg" class="img-thumbnail" alt="Cinque Terre">
 <img src="images_gym/image_gym_3.jpg" class="img-thumbnail" alt="Cinque Terre">
 <img src="images_gym/image_gym_4.jpg" class="img-thumbnail" alt="Cinque Terre">
          ...
          <?php while($data=mysqli_fetch_array($resultat1)){?>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    <img class="card-img-top" src="img_m/<?php echo $data['img_e'];?>" alt="">
                    <div class="card-social d-flex align-items-center justify-content-center">
                        <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 40px; height: 40px;" href="<?php echo $data['face'];?>"><i class="fab fa-twitter"></i></a>
                        <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 40px; height: 40px;" href="<?php echo $data['face'];?>"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 40px; height: 40px;" href="<?php echo $data['face'];?>"><i class="fab fa-linkedin-in"></i></a>
                        <a class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 40px; height: 40px;" href="<?php echo $data['face'];?>"><i class="fab fa-instagram"></i></a>
                    </div>
                    <div class="card-body bg-secondary">
                        <h4 class="card-title text-primary">Trainer Name</h4>
                        <p class="card-text"><?php echo $data['nom_e'];?> <?php echo $data['prenom_e'];?></p>
                        <p class="card-text"> Experience:<?php echo $data['experence'];?></p>
                    </div>
                </div>
            </div>
