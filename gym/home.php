            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h2 class="display-2 m-0 mt-2 mt-md-4 text-green font-weight-bold text-capitalize">Best Gym In Town</h2>
                        <?php 
...
?><br> <h1 style="display:inline; " class="m-0 display-4 font-weight-bold text-uppercase text-white">Nombre de present maintenante :</h1><h1 style="display:inline; " class="m-0 display-4 font-weight-bold text-uppercase text-white"> <?php  echo $num;?></h1>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h3 class="text-primary text-capitalize m-0">Gym & Fitness Center</h3>
                        <h2 class="display-2 m-0 mt-2 mt-md-4 text-green font-weight-bold text-capitalize">Get Body In Shape</h2>
                        <?php 
