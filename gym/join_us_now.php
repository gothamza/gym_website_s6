<?php
   ...
   $nombre_de_mois = $_POST['nombre_de_mois'];
   $entrineur=$_POST['entrineur'];
   if($entrineur=='flan'||$entrineur=='flan1'){
   $paiment=$nombre_de_mois*200;}
   else{$paiment=$nombre_de_mois*150;}
    // Database connection
    $req="INSERT INTO engage (nombre_de_mois,date_dub,entrineur,paiment,date_fin,nombre_jour_rest) values ('$nombre_de_mois','1','$entrineur','$paiment','2','3')";
    ...
    <div class="container-fluid p-0 nav-bar">
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            <a href="" class="navbar-brand">
                <h1 class="m-0 display-4 font-weight-bold text-uppercase text-white">yassine</h1>
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4 bg-secondary">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">regeme</a>
                        <div class="dropdown-menu text-capitalize">
                            <a href="blog.html" class="dropdown-item">tadkhime</a>
                            <a href="single.html" class="dropdown-item">tanxife</a>
                        </div>
                    </div>
